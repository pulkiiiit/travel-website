    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          {!isLogin && <p className="text-xs text-muted-foreground mt-1.5">At least 8 characters required</p>}
        </div>
        ...
        {isLogin && (
          <div className="flex items-center">
            <input
              ...
              type="checkbox"
              disabled={isLoading}
              className="w-4 h-4 rounded border-border bg-input text-primary focus:ring-2 focus:ring-primary/50 cursor-pointer disabled:opacity-50"
            />
